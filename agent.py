...
def get_agent():
    ...
    # Fast path: agent already created
    ...
    with _agent_lock:
        ...
        from subagents import metrics_subagent, sentiment_subagent, web_subagent, elastic_subagent
        from tools import (
        ...
        logger.info("Creating DevRel Research Agent")
...
def reset_agent() -> None:
    ...
    """
    global _agent, _config_validated
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        query = "Evaluate langchain-ai/deepagents for building DevRel research automation"
